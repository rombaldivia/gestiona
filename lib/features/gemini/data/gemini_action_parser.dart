...
class GeminiActionParser {
  ...
  static GeminiAction? _fromMap(Map<String, dynamic> m) {
    ...
    switch (type) {
      case 'create_quote':        return GeminiAction(type: GeminiActionType.createQuote,       params: params, description: desc);
      case 'create_work_order':   return GeminiAction(type: GeminiActionType.createWorkOrder,    params: params, description: desc);
      case 'add_inventory_item':  return GeminiAction(type: GeminiActionType.addInventoryItem,   params: params, description: desc);
      case 'change_quote_status': return GeminiAction(type: GeminiActionType.changeQuoteStatus,  params: params, description: desc);
      default: return null;
    }
  }
}
